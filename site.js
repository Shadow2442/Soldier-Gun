...
if (flightCanvas) {
  ...
  const spriteSheets = {
    idle: createSpriteSheet(`output/ship_idle_sheet.png?v=${FLIGHT_ASSET_VERSION}`),
    left: createSpriteSheet(`output/ship_strafe_left_sheet.png?v=${FLIGHT_ASSET_VERSION}`),
    right: createSpriteSheet(`output/ship_strafe_right_sheet.png?v=${FLIGHT_ASSET_VERSION}`),
  };
  const flameRects = [
